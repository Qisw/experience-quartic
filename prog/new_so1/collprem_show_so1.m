...
for iPlot = 1 : 4
   ...
   for iAge = [1, ngAge]
      ...
      % Age range to use
      meanAge = round(mean(cS.dataS.ageRangeYoungOldM(iAge, 1) : cS.dataS.ageRangeYoungOldM(iAge, 2)));
      ageV    = meanAge + (-3 : 3);
      %ageV = cS.dataS.ageRangeYoungOldM(iAge, 1) : cS.dataS.ageRangeYoungOldM(iAge, 2);
