...
if saveFigures >= 0
   ...
   save_fig_so1([prefixStr, 'eff_asc'], saveFigures, figS.figOpt4S, cS);
end
...
if 01
   [~, yMax] = output_so1.y_range(sTimeM(:), cS.missVal);
...
if 1
   %[hMin, hMax] = output_so1.y_range(log_lh(hM(:), cS.missVal), cS.missVal);
   age1 = cS.demogS.workStartAgeV(1);
   age2 = cS.demogS.ageRetire;
   ...
   for iSchool = 1 : cS.nSchool
      ...
      save_fig_so1(figFn, saveFigures, figS.figOptS, cS);
   end
end
