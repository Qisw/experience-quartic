...
if 0
   ...
   for iSchool = 1 : cS.nSchool
      ...
      ageV = max(cS.demogS.workStartAgeV(iSchool), cS.calS.profileDevAgeRangeV(1)) : cS.calS.profileDevAgeRangeV(2);
...
%       spV = guess_extract_lh(guess2V, optS.lbV, optS.ubV, optS);
      ...
      for iSchool2 = 1 : cS.nSchool
         % Ages for which to compare
         age2V = max(cS.demogS.workStartAgeV(iSchool2), cS.calS.profileDevAgeRangeV(1)) : cS.calS.profileDevAgeRangeV(2);
