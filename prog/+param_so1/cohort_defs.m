...
elseif cohDefStr.equals('quartic')
   % More cohort for quartic. Not important to have complete profiles
   bYearV = (1920 : 1980)';
   bYearWindow = 0;
   % Show these cohorts
   byShowV = round(linspace(find(bYearV == 1935), find(bYearV == 1965), 8))';
   byShow4V = byShowV(2 : 5);
   % No of theta spline nodes
   nThetaNodes = 6;

elseif cohDefStr.equals('annual')
   % All Cohorts
   bYearV = (1935 : 1 : 1969)';
   % Window of +/- bYearWindow years
   bYearWindow = 0;
...
elseif cohDefStr.equals('bowlus')
   % Bowlus / Robinson
   bYearV = (1934 : 3 : 1964)';
   bYearWindow = 1;
   % Show these cohorts
