...
if setNo == setS.dataSetNo
   ...
   elseif setNo == setS.setTest
      ...
      cS.calWhatS.substElast = false;
%       cS.pvector.change('seCG',  [], [],  3, 0.5, 10, cS.calNever);
%       cS.pvector.change('seHS',  [], [],  5, 0.5, 10, cS.calNever);
      % Fix all alphas
      %cS.pvector.calibrate('alphaHSD', cS.calNever);
      %cS.pvector.calibrate('alphaHSG', cS.calNever);
      %cS.pvector.calibrate('alphaCD', cS.calNever);
      %cS.pvector.calibrate('alphaCG', cS.calNever);
