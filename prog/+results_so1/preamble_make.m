...
% %% CPS filter
% 
% fltS = data_load_so1(cS.varNoS.vCpsEarnFilter, cS);
% 
% add_one('fracBusInc', fltS.fracBusInc .* 100, '%.0f', 'Fraction of business income');
% add_one('hoursMin', fltS.hoursMin, '%.0f', 'Min hours');
% add_one('weeksMin', fltS.weeksMin, '%.0f', 'Min weeks');
% 
...
% *****  Aggregation
add_one('wageAgeRangeOne', cS.calS.profileDevAgeRangeV(1), '%i', 'wage age 1', cS);
add_one('wageAgeRangeLast', cS.calS.profileDevAgeRangeV(end), '%i', 'wage age N', cS);
