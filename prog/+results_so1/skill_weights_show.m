...
modelS.skillWeight_stM = results_so1.skill_weights_normalize(modelS, cS);
...
% Normalize skill weights relative to HSG
dataS.skillWeight_stM = results_so1.skill_weights_normalize(dataS, cS);
...
results_so1.plot_skill_weights(modelS.skillWeight_stM, modelS.yearV, 'skill_weights', saveFigures, cS);
results_so1.plot_skill_weights(dataS.skillWeight_stM, dataS.yearV, 'skill_weights_hours', saveFigures, cS);
