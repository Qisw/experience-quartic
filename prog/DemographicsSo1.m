...
classdef DemographicsSo1
   ...
   methods
      ...
      IN
         demogSettingS
            struct with named choices (see const_so1)
      %}
      function dS = DemographicsSo1(age1, ageRetire, workStartAgeV, demogSettingS)
         dS.cohDefStr = demogSettingS.cohDefStr;
      ...
      function dS = derived(dS)
         ...
         [dS.bYearV, bYearWindow, dS.byShowV, dS.byShow4V, dS.cohStrV] = param_so1.cohort_defs(dS.cohDefStr);
