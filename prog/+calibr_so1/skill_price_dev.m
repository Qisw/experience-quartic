...
if strcmpi(cS.spSpecS.inSampleType, 'sbtc')
   ...
   validateattributes(devSkillWeightV, {'double'}, {'finite', 'nonnan', 'nonempty', 'real', '>=', 0, ...
      'size', [cS.nSchool, 1]})
   scalarSkillWeightDev = 100 * mean(devSkillWeightV);
...
if strcmp(spS.beforeSampleType, 'constGrowth')
   ...
   validateattributes(beforeDevV, {'double'}, {'finite', 'nonnan', 'nonempty', 'real', '>=', 0, ...
      'size', [cS.nSchool, 1]})
...
if strcmp(spS.afterSampleType, 'constGrowth')
   ...
   validateattributes(afterDevV, {'double'}, {'finite', 'nonnan', 'nonempty', 'real', '>=', 0, ...
      'size', [cS.nSchool, 1]})
